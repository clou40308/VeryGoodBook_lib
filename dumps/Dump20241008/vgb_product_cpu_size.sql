...
CREATE TABLE `product_cpu_size` (
  ...
  CONSTRAINT `FKEY_product_cpu_size_TO_products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`)
...
INSERT INTO `product_cpu_size` VALUES (8,'Ultra 5','14',31,29990,3),(8,'Ultra 5','16',18,29990,4),(8,'Ultra 7','14',20,33990,1),(8,'Ultra 7','16',23,33990,2),(9,'','13.3',1,37900,5),(9,'','14',3,38900,6),(9,'','16',5,45900,7);
